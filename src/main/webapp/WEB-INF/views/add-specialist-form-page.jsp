					...
					<form:form action="/portal/addSpecialist" method="post"
						...
						<div class="form-group">
							...
							<form:select path="areaOfExpertise" class="form-control" id="areaOfExpertise"
								items="${areaOfExpertise}" required="required" />
						</div>
						<div class="form-group">
							<form:label path="experienceInYears">Experience In Years:</form:label>
							<form:input path="experienceInYears" class="form-control" id="experienceInYears"
								type="number" required="required"  />
						</div>
						<div class="form-group">
							<form:label path="contactNumber">Contact Number:</form:label>
							<form:input path="contactNumber" class="form-control" id="contactNumber"
								type="number" required="required" pattern="^[7-9]{1}[0-9]{9}$" />
						</div>
						
						<input type="submit" class="btn btn-primary" value="Add Specialist">
					</form:form>
				</div>
