...
<div class="side-navbar">
	...
	<li><a href="/portal/adminSpecialists">Our Specialists</a></li>
		<li><a href="/portal/adminIpTreatmentPackages">Our Service Packages</a></li>
		<li><a href="/portal/ipTreatmentPackageByName">Search Package</a></li>
		
		<li><a href="/portal/ipTreatmentspecialist">Search Specialist</a></li>
